...
/*
** PLANETOID GRAVITY CLASS
*/
class PlanetoidGravity : public Force {

public:
	// constructor
	PlanetoidGravity() {}
	PlanetoidGravity(float gravity, Body* planetoid) { m_gravity = gravity; m_planetoid = planetoid; }

	// get and set methods
	float getGravity() const { return m_gravity; }
	void setGravity(float gravity) { m_gravity = gravity; }
	Body* getPlanetoid() const { return m_planetoid; }
	void setPlanetoid(Body* planetoid) { m_planetoid = planetoid; }
...
public:
	...
	SurfaceDrag(Body* b1, Body* b2, Body* b3, glm::vec3 wind) {
		m_wind = wind; m_b1 = b1; m_b2 = b2; m_b3 = b3;
	}
